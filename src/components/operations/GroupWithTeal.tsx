...
const program = new Uint8Array(
  Buffer.from(
    "AiACAgAyBCISMwEIIxIQMwAIIxIQMwAHMwEAEhAzAQczAAASEDMBIDIDEhAzASAyAxIQMwEJMgMSEDMAIDIDEhAzACAyAxIQMwAJMgMSEA==",
    "base64"
  )
);
  ...
  const onClickSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const response = await algodClient
        .sendRawTransaction([signedTx1.blob, signedTx2.blob])
        .do();
